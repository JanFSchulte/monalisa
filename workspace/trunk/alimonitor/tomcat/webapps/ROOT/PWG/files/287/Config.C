...
//    Pythia MB Perugia11 + Omega as Trigger Particle

// The same can be done for Xi, wih MbPythiaTunePerugia11AndXiEnhancement
//    Pythia MB Perugia11 + Xi    as Trigger Particle
...
enum PDC06Proc_t 
{
  kPythia6, kPythia6D6T, kPythia6ATLAS, kPythia6ATLAS_Flat, kPythiaPerugia11, kPythiaTunePerugia11AndOmegaEnhancement, kPythiaTunePerugia11AndXiEnhancement, kPhojet, kRunMax
};

const char * pprRunName[] = {
  "kPythia6", "kPythia6D6T", "kPythia6ATLAS", "kPythia6ATLAS_Flat", "kPythiaPerugia11", "kPythiaTunePerugia11AndOmegaEnhancement", "kPythiaTunePerugia11AndXiEnhancement", "kPhojet"
};
