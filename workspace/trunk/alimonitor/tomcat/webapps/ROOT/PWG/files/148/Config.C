...
enum PDC06Proc_t
{
  kPythia6, kPythia6D6T, kPhojet, kFlatJPsi, kJPsi7TeV, kRunMax
};

const char * pprRunName[] = {
    "kPythia6", "kPythia6D6T", "kPhojet", "kFlatJPsi", "kJPsi7TeV"
};
...
void Config()
{
  ...
  //gAlice->SetTriggerDescriptor("p-p"); not needed for MUON standalone
...
AliGenerator* MbPythia()
{
      comment = comment.Append(" pp at 900 GeV");
//
//    Pythia
