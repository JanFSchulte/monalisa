...
static Float_t bMax = 0.;
static UInt_t  quench = 0;
static UInt_t  shad = 0;
static Float_t etaMin = 0.;
static Float_t etaMax = 0.;
static Float_t phiMin = 0.;
static Float_t phiMax = 0.;
...
//    // Run number
// Function no more available => Now private
