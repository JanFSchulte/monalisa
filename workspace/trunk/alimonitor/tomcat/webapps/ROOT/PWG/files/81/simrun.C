...
// root.exe -b -q simrun.C  --run <x> --event <y> 
...
//  gSystem->Exec("aliroot -b -q CreateAODfromESD.C > aod.log 2>&1");
  gSystem->Exec("aliroot -b -q CreateStandardAODfromESD.C > aod.log 2>&1");
  cout<<">>>>> AODvertexingHF <<<<<"<<endl;
  gSystem->Exec("aliroot -b -q AliAnalysisTaskSEVertexingHFTest.C > aodVertexingHF.log 2>&1");
}}
