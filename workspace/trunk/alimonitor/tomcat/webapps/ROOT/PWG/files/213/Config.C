...
// A bbbar per event, a b-hadron in |y|<2, b-hadrons decay to jpsi+X 
//
...
enum PDC06Proc_t 
{
  kPythia6, kPythia6D6T, kPythia6ATLAS, kPythia6ATLAS_Flat, kPythiaPerugia0, kPhojet, kPythiaPerugia0chadr, kPythiaPerugia0bchadr, kPythiaPerugia0cele, kPythiaPerugia0bele, kPythiaPerugia0Jpsi, kPythiaPerugia0BtoJpsi,  kRunMax
};

const char * pprRunName[] = {
  "kPythia6", "kPythia6D6T", "kPythia6ATLAS", "kPythia6ATLAS_Flat", "kPythiaPerugia0", "kPhojet", "kPythiaPerugia0chadr", "kPythiaPerugia0bchadr", "kPythiaPerugia0cele", "kPythiaPerugia0bele", "kPythiaPerugia0Jpsi", "kPythiaPerugia0BtoJpsi"
};
...
void Config()
{
  ...
  if (proc == kPythiaPerugia0BtoJpsi) decayer->SetForceDecay(kBJpsiDiElectron);
  decayer->Init();
  ...
  } else if (proc == kPythiaPerugia0BtoJpsi) {
      gener = MbPythiaTunePerugia0BtoJpsi();
  }
...
{
      comment = comment.Append(" pp: Pythia (Perugia0) chadr (1 ccbar per event, 1 c-hadron in |y|<1, chadrons decay to hadrons");
//
//    Pythia
      AliGenPythia* pythia = new AliGenPythia(-1); 
      pythia->SetMomentumRange(0, 999999.);
...
{
      comment = comment.Append(" pp: Pythia (Perugia0) cele (1 ccbar per event, 1 c-hadron in |y|<1, 1 electron in |y|<2");
//
//    Pythia
      AliGenPythia* pythia = new AliGenPythia(-1); 
      pythia->SetMomentumRange(0, 999999.);
...
AliGenerator* MbPythiaTunePerugia0BtoJpsi()
{
