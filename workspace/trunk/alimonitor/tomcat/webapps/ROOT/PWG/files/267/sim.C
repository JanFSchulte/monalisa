...
//----- Seting PMD specific OCDB ------

  simulator.SetSpecificStorage("PMD/Calib/Hot",   "alien://folder=/alice/data/2010/OCDB");
  simulator.SetSpecificStorage("PMD/Calib/Gain",  "alien://folder=/alice/data/2010/OCDB");
  simulator.SetSpecificStorage("PMD/Align/Data",  "alien://folder=/alice/data/2010/OCDB");
//----------------------
