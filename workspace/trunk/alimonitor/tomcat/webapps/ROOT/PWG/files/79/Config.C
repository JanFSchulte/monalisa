...
static YCut_t        ycut     = kBarrel;    // actual value set in MbCocktail
...
AliGenerator* MbCocktail()
{
      comment = comment.Append(" pp at 10 TeV: Pythia low-pt, no heavy quarks + J/Psi from parameterisation");
...
//   J/Psi parameterisation
      ...
      // jpsi->SetYRange(-8., 8.);
      jpsi->SetYRange(-2., 2.); //this to speed up !!!
