...
//----- Seting PMD specific OCDB ------
  ...
  reco.SetSpecificStorage("PMD/Calib/Hot",   "alien://folder=/alice/data/2010/OCDB");
  reco.SetSpecificStorage("PMD/Calib/Gain",  "alien://folder=/alice/data/2010/OCDB");
  reco.SetSpecificStorage("PMD/Align/Data",  "alien://folder=/alice/data/2010/OCDB");
