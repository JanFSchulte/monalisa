//
// Configuration for the Xi or Omega-enhanced MC production p+p 2.76 TeV
// (similar to that used in LHC11a6a or LHC11a6b for p+p 7 TeV data) 
//

// MC production corresponding to p+p 2.76 TeV data 
// 50% of events have a generated Omega-
// 50% of events have a generated Omega+
// Introduction of a new AliGenerator = MbPythiaTunePerugia11AndOmegaEnhancement
//    Pythia MB Perugia0 + Omega as Trigger Particle

// The same can be done for Xi, wih MbPythiaTunePerugia11AndXiEnhancement
//    Pythia MB Perugia0 + Xi    as Trigger Particle

// MbPythiaTunePerugia11AndHighPtLambdaEnhancement:
//    Pythia MB Perugia0 + Lambda(pt>2GeV/c)    as Trigger Particle

// MbPythiaTunePerugia11AndHighPtAntiLambdaEnhancement:
//    Pythia MB Perugia0 + AntiLambda(pt>2GeV/c)    as Trigger Particle

// MbPythiaTunePerugia11AndHighPtK0ShortEnhancement: 
//    Pythia MB Perugia0 + K0Short(pt>2GeV/c)    as Trigger Particle
...
enum PDC06Proc_t 
{
  kPythia6, kPythia6D6T, kPythia6ATLAS, kPythia6ATLAS_Flat, kPythiaPerugia11, kPythiaTunePerugia11AndOmegaEnhancement, kPythiaTunePerugia11AndXiEnhancement, kPythiaTunePerugia11AndHighPtLambdaEnhancement, kPythiaTunePerugia11AndHighPtAntiLambdaEnhancement, kPythiaTunePerugia11AndHighPtK0ShortEnhancement, kPhojet, kRunMax
};
...
static PDC06Proc_t   proc     = kPythiaTunePerugia11AndHighPtLambdaEnhancement;
...
//    gSystem->Load("libpythia6.4.25");   // Pythia 6.4.25 needed for tune Perugia-11 (not available for v4-20-Rev-25)       
  }
  ...
  } else if (proc == kPythiaPerugia11) {
      gener = MbPythiaTunePerugia11();
  } else if (proc == kPythiaTunePerugia11AndOmegaEnhancement) {
      gener = MbPythiaTunePerugia11AndOmegaEnhancement();
  } else if (proc == kPythiaTunePerugia11AndXiEnhancement) {
      gener = MbPythiaTunePerugia11AndXiEnhancement();
  } else if (proc == kPythiaTunePerugia11AndHighPtLambdaEnhancement) {
      gener = MbPythiaTunePerugia11AndHighPtLambdaEnhancement();
  } else if (proc == kPythiaTunePerugia11AndHighPtAntiLambdaEnhancement) {
      gener = MbPythiaTunePerugia11AndHighPtAntiLambdaEnhancement();
  } else if (proc == kPythiaTunePerugia11AndHighPtK0ShortEnhancement) {
      gener = MbPythiaTunePerugia11AndHighPtK0ShortEnhancement();
...
AliGenerator* MbPythiaTunePerugia11()
{
...
AliGenerator* MbPythiaTunePerugia11AndOmegaEnhancement()
{
//      comment = comment.Append(" pp: Pythia low-pt (Perugia11) + __Omega__ enhancement");
      comment = comment.Append(" pp: Pythia low-pt (Perugia0) + __Omega__ enhancement");
//
//    Pythia
      AliGenPythia* pythia = new AliGenPythia(-1); 
      pythia->SetMomentumRange(0, 999999.);
...
//      pythia->SetTune(350); 
      ...
      pythia->SetCrossingAngle(0,0.000280);
      if (gRandom->Rndm() < 0.5)
	pythia->SetTriggerParticle(3334, 1.2);
      else
	pythia->SetTriggerParticle(-3334, 1.2);
...
AliGenerator* MbPythiaTunePerugia11AndXiEnhancement()
{
//      comment = comment.Append(" pp: Pythia low-pt (Perugia11) + __Xi__ enhancement");
      comment = comment.Append(" pp: Pythia low-pt (Perugia0) + __Xi__ enhancement");
//
//    Pythia
      AliGenPythia* pythia = new AliGenPythia(-1); 
      pythia->SetMomentumRange(0, 999999.);
...
//      pythia->SetTune(350); 
      ...
      pythia->SetCrossingAngle(0,0.000280);
      if (gRandom->Rndm() < 0.5)
	pythia->SetTriggerParticle(3312, 1.2);
      else
	pythia->SetTriggerParticle(-3312, 1.2);
...
AliGenerator* MbPythiaTunePerugia11AndHighPtLambdaEnhancement()
{
//      comment = comment.Append(" pp: Pythia low-pt (Perugia11) + __Xi__ enhancement");
      comment = comment.Append(" pp: Pythia low-pt (Perugia0) + __HighPtLambda__ enhancement");
//
//    Pythia
      AliGenPythia* pythia = new AliGenPythia(-1); 
      pythia->SetMomentumRange(0, 999999.);
...
//      pythia->SetTune(350); 
      ...
      pythia->UseNewMultipleInteractionsScenario();
      pythia->SetCrossingAngle(0,0.000280);
      pythia->SetTriggerParticle(3122, 1.2, 2, 15); //needs new patch
//
      return pythia;
}

AliGenerator* MbPythiaTunePerugia11AndHighPtAntiLambdaEnhancement()
{
//      comment = comment.Append(" pp: Pythia low-pt (Perugia11) + __Xi__ enhancement");
      comment = comment.Append(" pp: Pythia low-pt (Perugia0) + __HighPtAntiLambda__ enhancement");
//
//    Pythia
      AliGenPythia* pythia = new AliGenPythia(-1); 
      pythia->SetMomentumRange(0, 999999.);
...
AliGenerator* MbPythiaTunePerugia11AndHighPtK0ShortEnhancement()
{
//      comment = comment.Append(" pp: Pythia low-pt (Perugia11) + __Xi__ enhancement");
      comment = comment.Append(" pp: Pythia low-pt (Perugia0) + __HighPtK0Short__ enhancement");
//
//    Pythia
      AliGenPythia* pythia = new AliGenPythia(-1); 
      pythia->SetMomentumRange(0, 999999.);
...
//      pythia->SetTune(350); 
      ...
      pythia->UseNewMultipleInteractionsScenario();
      pythia->SetCrossingAngle(0,0.000280);
      pythia->SetTriggerParticle(310, 1.2, 2, 20); //needs new patch
//
      return pythia;
}
