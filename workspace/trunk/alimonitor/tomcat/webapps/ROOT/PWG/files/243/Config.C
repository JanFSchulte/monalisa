//
// Configuration for the Omega-enhanced MC production
//

// MC production corresponding to p+p 7 TeV data 
// 50% of events have a generated Omega-
// 50% of events have a generated Omega+
// Introduction of a new AliGenerator = MbPythiaTunePerugia0AndOmegaEnhancement
//    Pythia MB Perugia 0 + Omega as Trigger Particle

// The same can be done for Xi, wih MbPythiaTunePerugia0AndXiEnhancement
//    Pythia MB Perugia 0 + Xi    as Trigger Particle
...
enum PDC06Proc_t 
{
  kPythia6, kPythia6D6T, kPythia6ATLAS, kPythia6ATLAS_Flat, kPythiaPerugia0, kPythiaTunePerugia0AndOmegaEnhancement, kPythiaTunePerugia0AndXiEnhancement, kPhojet, kRunMax
};

const char * pprRunName[] = {
  "kPythia6", "kPythia6D6T", "kPythia6ATLAS", "kPythia6ATLAS_Flat", "kPythiaPerugia0", "kPythiaTunePerugia0AndOmegaEnhancement", "kPythiaTunePerugia0AndXiEnhancement", "kPhojet"
};
...
void Config()
{
  ...
  } else if (proc == kPythiaTunePerugia0AndOmegaEnhancement) {
      gener = MbPythiaTunePerugia0AndOmegaEnhancement();
  } else if (proc == kPythiaTunePerugia0AndXiEnhancement) {
      gener = MbPythiaTunePerugia0AndXiEnhancement();
...
AliGenerator* MbPythiaTunePerugia0AndOmegaEnhancement()
{
...
AliGenerator* MbPythiaTunePerugia0AndXiEnhancement()
{
