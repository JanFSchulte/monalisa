void sim(Int_t nev=100) {
  ...
  simulator.SetMakeDigits("TOF EMCAL VZERO");
  simulator.SetMakeDigitsFromHits("ITS TPC");
  simulator.SetRunQA(":") ; 
//
//
...
//
// Trigger configurations from RAW OCDB
  simulator.SetSpecificStorage("GRP/CTP/Config/",               "alien://folder=/alice/data/2010/OCDB");
  simulator.SetSpecificStorage("GRP/CTP/CTPtiming/",            "alien://folder=/alice/data/2010/OCDB");
  simulator.SetSpecificStorage("GRP/CTP/DummyConfig/",          "alien://folder=/alice/data/2010/OCDB");
  simulator.SetSpecificStorage("GRP/CTP/DummyCTPtime/",         "alien://folder=/alice/data/2010/OCDB");
  simulator.SetSpecificStorage("GRP/CTP/DummyScalers/",         "alien://folder=/alice/data/2010/OCDB");
  simulator.SetSpecificStorage("GRP/CTP/LTUConfig/",            "alien://folder=/alice/data/2010/OCDB");
  simulator.SetSpecificStorage("GRP/CTP/Scalers/",              "alien://folder=/alice/data/2010/OCDB");
  simulator.SetSpecificStorage("GRP/CTP/TimeAlign/",            "alien://folder=/alice/data/2010/OCDB");
//
// ITS
//    SDD from RAW OCDB
