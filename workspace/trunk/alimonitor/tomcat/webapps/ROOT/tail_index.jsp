<%
    lia.web.servlets.web.Utils.logRequest("START /tail_index.jsp", 0, request);
    ...
    if (site==null || site.length()==0 || service==null || service.length()==0){
...
<html>
<head>
    <title>Watching <%=service%> log on <%=site%></title>
...
<table style="font-family:Arial,Verdana,Helvetica;font-size:12px" class="text" cellspacing="0" cellpadding="0" width=100% height=100%>
    <tr height=20>
	<td colspan=4 align=center style="font-size:14px" nowrap><b>Watching <%=service%> log on <%=site%></b></td>
    </tr>
    <tr>
	<td colspan=4  style="border: solid 1px #CCCCCC; padding: 5px;">
	    <iframe id="tail_frame" name="tail_frame" src="/tail.jsp?site=<%=site%>&service=<%=service%>" width="100%" height="100%" frameborder="0">
	    </iframe>
	</td>
    </tr>
    ...
    lia.web.servlets.web.Utils.logRequest("/tail_index.jsp", 1, request);
%>