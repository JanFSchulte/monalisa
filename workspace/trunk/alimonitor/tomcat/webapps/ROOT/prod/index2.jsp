...
%><%
	...
	final int idx = key.indexOf("_Stage");
	
	if (idx>0){
	    // the parent is the next entry, if any
	    
	    final int stage = Integer.parseInt(key.substring(idx+6));
	    
	    final Map<String, Object> next = list.get(i+1);
	    
	    final Map<String, Object> nextValues = (Map<String, Object>) entry.get("values");
