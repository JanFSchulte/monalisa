<tr bgcolor="<<:bgcolor:>>" class="table_row">
    ...
    <td sorttable_customkey="<<:site esc:>>" nowrap align=right class="table_row" style="padding-left: 15px; padding-right: 15px; padding-bottom: 5px;"><<:Authen:>></td>
    ...
    <td sorttable_customkey="<<:site esc:>>" nowrap align=right class="table_row" style="padding-left: 15px; padding-right: 15px; padding-bottom: 5px;"><<:JobBroker:>></td>
    <td sorttable_customkey="<<:site esc:>>" nowrap align=right class="table_row" style="padding-left: 15px; padding-right: 15px; padding-bottom: 5px;"><<:FTD:>></td>
    <td sorttable_customkey="<<:site esc:>>" nowrap align=right class="table_row" style="padding-left: 15px; padding-right: 15px; padding-bottom: 5px;"><<:IS:>></td>
