...
<table cellspacing=0 cellpadding=5 class="table_content">
    <tr height=25>
	<td style="border-left: 1px solid #C0D5FF;"><a href="/services.jsp" class="menu_link_active"><b>Site services management</b></a></td>
	<td style="background-color: #F0F0F0"><a href="/centralservices/" class="menu_link_active"><b>Central services management</b></a></td>
...
<table cellspacing=0 cellpadding=3 class="table_content" align="left">
    <tr height=25>
	<td class="table_title"><b>Central services management</b></td>
    </tr>
    <tr>
	<td>
		...
		<tr class="table_header">
		    ...
		    <td colspan=5 align=center class="table_header" style="border-bottom: 0px;">
			Services
		    </td>
		    <td class="table_header" style="border-bottom: 0px;">
		...
		<tfoot>
		<tr>
		    <td class=table_header colspan=8 align=right>
			<div align=right>
			    <input type=submit name=submit onClick="return doRestart()" value="Restart AliEn on selected sites" class="input_submit">
			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			    <input type=submit name=submit onClick="doConsole()" value="Multi-server console" class="input_submit">
			</div>
		    </td>
		</tr>
		</tfoot>
