...
var MENU_ITEMS = [
	...
	{code:"Status <img src=\"/img/down_arrow.png\" width=\"12\" height=\"12\"/>",
		sub:[
			...
			style: title_style[0],
			code:"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;All", ocode:"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;All",
			url:"http://alimonitor.cern.ch/trend.jsp?filter=0"+sort_link
			},
			...
			url:"http://alimonitor.cern.ch/trend.jsp?filter=1"+sort_link
			},
			...
			url:"http://alimonitor.cern.ch/trend.jsp?filter=2"+sort_link
			...
			url:"http://alimonitor.cern.ch/trend.jsp?filter=3"+sort_link
