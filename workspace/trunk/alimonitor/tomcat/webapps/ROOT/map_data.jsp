...
%><%
	...
	if (iMaxJobs < iRunningJobs){
	    db2.syncUpdateQuery("update running_jobs_cache set maxrunningjobs="+iRunningJobs+" where name='"+Format.escSQL(sName)+"';");
	
	    if (db2.getUpdateCount()==0){
	        db2.syncUpdateQuery("insert into running_jobs_cache (name, maxrunningjobs) values ('"+Format.escSQL(sName)+"', "+iRunningJobs+");");
	    }
