...
*/    
	...
	db2.query("select to_char(to_timestamp(max(run_start)), 'DD Mon YYYY') as last_run,max(run_start) as last_run_timestamp from train_run where train_id='"+db.geti("train_id")+"'");
	pEl.modify("last_run", db2.gets(1));
	pEl.modify("last_run_timestamp", db2.geti(2));
