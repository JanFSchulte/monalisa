<%@ page import="lia.Monitor.Store.Fast.DB,lia.Monitor.Store.Cache,lia.web.utils.Formatare,lia.Monitor.monitor.monPredicate,java.util.*,java.io.*,lia.web.servlets.web.*,lia.web.utils.*" %><%
    lia.web.servlets.web.Utils.logRequest("START /login_failed.jsp", 0, request);
    ...
    Page pLogin = new Page(baos, RES_PATH+"/masterpage/login_error.res");    
...
//  pMaster.comment("com_menu", false);
    ...
    lia.web.servlets.web.Utils.logRequest("/login_failed.jsp", baos.size(), request);
%>