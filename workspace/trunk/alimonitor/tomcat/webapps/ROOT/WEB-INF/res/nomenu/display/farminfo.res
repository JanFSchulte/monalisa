...
<table border=0 cellspacing=0 cellpadding=0>
    ...
    <tr>
	<td><img width=400 height=180 src="display?width=400&height=180&img=true&page=sample_farminfo_3&pTime=<<:pTime enc:>>&Farms=<<:farm enc:>>&interval.min=<<:interval.min:>>&interval.max=<<:interval.max:>>"></td>
	<td><img width=400 height=180 src="display?width=400&height=180&img=true&page=sample_farminfo_1&pTime=<<:pTime enc:>>&Farms=<<:farm enc:>>&interval.min=<<:interval.min:>>&interval.max=<<:interval.max:>>"></td>
    </tr>
    ...
    <tr>
	<td><img width=400 height=180 src="display?width=400&height=180&img=true&page=sample_farminfo_2&pTime=<<:pTime enc:>>&Farms=<<:farm enc:>>&interval.min=<<:interval.min:>>&interval.max=<<:interval.max:>>"></td>
	<td><img width=400 height=180 src="display?width=400&height=180&img=true&page=sample_farminfo_4&pTime=<<:pTime enc:>>&Farms=<<:farm enc:>>&interval.min=<<:interval.min:>>&interval.max=<<:interval.max:>>"></td>
    </tr>
</table>
<br>
<br>
