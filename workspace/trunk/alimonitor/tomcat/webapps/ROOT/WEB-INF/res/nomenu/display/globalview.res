...
<table border=0 cellspacing=0 cellpadding=0>
    ...
    <tr>
	<td><img width=400 height=300 src="display?legend=false&width=400&height=300&img=true&page=globalview1&interval.min=<<:interval.min:>>&interval.max=<<:interval.max:>>"></td>
