<%@ page import="java.util.*,java.io.*,java.text.SimpleDateFormat,java.awt.Color,lia.web.utils.*,lia.Monitor.Store.Fast.DB,lia.web.servlets.web.Utils,lia.Monitor.monitor.*,lia.Monitor.Store.*"%><%
    lia.web.servlets.web.Utils.logRequest("START /trend_small_new.jsp", 0, request);
    ...
    Page p = new Page(baos, BASE_PATH+"/trend_small.res");
    
    monPredicate pred = new monPredicate("_TOTALS_", "Site_Jobs_Summary", "jobs", -1000*60*60*24, -1, new String[]{"RUNNING_jobs"}, null);
    ...
    lia.web.servlets.web.Utils.logRequest("/trend_small_new.jsp", baos.size(), request);
%>