...
# with command line options: TTbar_Tauola_13TeV_cfi --conditions=MCRUN2_72_V0A:All --fast -n 10 --eventcontent FEVTDEBUGHLT -s GEN,SIM,RECO,EI,HLT:@relval --datatier GEN-SIM-DIGI-RECO --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --magField 38T_PostLS1 --no_exec
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TTbar_Tauola_13TeV_cfi_GEN_SIM_RECO_EI_HLT.root'),
...
process.GlobalTag = GlobalTag(process.GlobalTag, 'MCRUN2_72_V0A:All', '')
