...
//   ALIROOTVERSIONSHORT with the package name of the desired aliroot version (e.g. AliRoot::v4-21-33-AN)

void generate(const char* trainFolder, Bool_t copyData, const char *module = "")
{
   ...
   {
      Printf("ERROR: ALIROOT_VERSION_SHORT not set. Exiting...");
      return;
   }
